...
public class UserController {
    ...
    public ResponseEntity<Void> registerUser(@RequestParam String username, @RequestParam String password, @RequestParam String countryName) throws Exception{
        //create a user of given country. The originalIp of the user should be
        // "countryCode.userId" and return the user. Note that right now user is not connected
        // and thus connected would be false and maskedIp would be null
